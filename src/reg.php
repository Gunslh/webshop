            ...
            <div class="item">
                ...
                <div class="reg-name">
                    ...
                    <div class="item-info left">
                        <input id="loginname" class="text" type="text" autocomplete="off" tabindex="1"/>
                        <div class="i-name ico"></div>
                    </div>
                    <span class="left hits">User Name is required.</span>
                    <span class="left hits_err"></span>
                </div>
                <div class="reg-pass">
                    <span class="left label">Password:</span>
                    <div class="item-info left">
                        <input id="nloginpwd" class="text" tabindex="1" autocomplete="off" type="password"/>
                        <div class="i-pass ico"></div>
                    </div>
                    <span class="left hits">Enter your password.</span>
                    <span class="left hits_err"></span>
                </div>
                <div class="re-pass">
                    <span class="left label">Confirmed Password:</span>
                    <div class="item-info left">
                        <input id="ncloginpwd" class="text" tabindex="1" autocomplete="off" type="password"/>
                        <div class="i-pass ico"></div>
                    </div>
                    <span class="left hits">Enter your password again.</span>
                    <span class="left hits_err"></span>
                </div>
                <div class="reg-rname">
                    <span class="left label">Name:</span>
                    <div class="item-info left">
                        <input id="rname" class="text" type="text" autocomplete="off" tabindex="1"/>
                        <div class="i-name ico"></div>
                    </div>
                    <span class="left hits">Name is required.</span>
                    <span class="left hits_err"></span>
                </div>
                <div class="reg-phone">
                    <span class="left label">Phone:</span>
                    <div class="item-info left">
                        <input id="phone" class="text" type="text" autocomplete="off" tabindex="1"/>
                        <div class="i-name ico"></div>
                    </div>
                    <span class="left hits">Phone is required.</span>
                    <span class="left hits_err"></span>
                </div>
                <div class="reg-addr">
                    <span class="left label">Address:</span>
                    <div class="item-info left">
                        <input id="addr" class="text" type="text" autocomplete="off" tabindex="1"/>
                        <div class="i-name ico"></div>
                    </div>
                    <span class="left hits">Country is required.</span>
                    <span class="left hits_err"></span>
                </div>
                <div class="item-info btn-submit">
                    <input id="loginsubmit" class="btn-img btn-entry" type="button" tabindex="4" value="登录"/>
                </div>
            </div>
        </div>
    </div>
...
$(function () {
    function checkName() {
        ...
        if (!$('#loginname').val().match(/^([a-z0-9_\.-]+)@([\da-z\.-]+)\.([a-z\.]{2,6})$/)) {
            $('.reg-name .hits_err').html("User Name must be email").show();
            return false;
        }
        return true;
    }
    ...
    function checkPhone() {
        $('.reg-phone .hits_err').html("Phone Name required").show();
    }
